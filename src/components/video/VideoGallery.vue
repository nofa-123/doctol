...
const visibleVideos = computed(() => (showAll.value ? shown.value : shown.value.slice(0, 4)))

watch(active, () => { showAll.value = false })
...
<template>
  <section id="videos" class="section vg" :class="`vg--${tone}`">
    <div class="container container--wide">
      ...
      <div v-if="layout !== 'rail' && shown.length > 4" class="vg__more">
        <BaseButton variant="outline" icon-end="arrow-left" @click="showAll = !showAll">
