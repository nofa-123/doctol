...
@media (max-width: 767px) {
  .rc { gap: 10px; padding: 14px; }
  .rc__avatar { width: 38px; height: 38px; font-size: 0.7rem; }
  .rc__head { gap: 9px; }
  .rc__name { font-size: 0.72rem; }
  .rc__place { font-size: 0.61rem; }
  .rc__text { font-size: 0.72rem; line-height: 1.75; }
  .rc__foot { gap: 8px; padding-block-start: 9px; font-size: 0.62rem; }
  .rc__service { padding: 3px 8px; }
}
</style>
