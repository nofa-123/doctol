...
@media (max-width: 767px) {
  ...
  .rv__google-mark { width: 24px; height: 24px; }
  .rv__google { gap: 5px; }
  .rv__google-text strong { font-size: 0.62rem; }
  .rv__google-text small { font-size: 0.52rem; }
  .rv__score { font-size: 1.55rem; }
  .rv__score-of,
  .rv__count small { font-size: 0.58rem; }
  .rv__count strong { font-size: 1.25rem; }
  .rv__item { width: min(82vw, 340px); }
}
